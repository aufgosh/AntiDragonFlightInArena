local function OnEvent(self, event, ...)
	...
	GetZoneText() == "Ashamane's Fall" or GetZoneText() == "Black Rook Hold Arena" or GetZoneText() == "Hook Point" or GetZoneText() == "The Mugambala" or GetZoneText() == "The Robodrome" or
